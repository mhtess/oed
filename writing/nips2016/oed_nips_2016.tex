...
Categorization of an object is thus a function of its similarity to A prototype  A versus its similarity to the B prototype.\footnote{The prototype model Medin and Schaffer considered produced oridinal predictions; we consider a transformation of this model that produces continuous predictions.}
