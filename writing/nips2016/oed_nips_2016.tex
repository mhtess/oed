...
Figure~\ref{fig:dist}b shows that, while both experiments achieve maximal actual information gain with 60 participants, the optimal experiment reaches this maximum with only 10 participants, whereas the MS experiment requires 30.
