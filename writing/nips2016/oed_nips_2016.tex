...
\end{lstlisting}
%\end{minipage}
Our OED code is as a WebPPL package at \url{https://censored}. %--- \url{https://github.com/mhtess/webppl-oed}.
...
\begin{lstlisting}
var n = 20; 
var fairGroup = groupify(fairCoin,n), biasGroup = groupify(biasCoin,n)
