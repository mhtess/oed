...
We computed the expected information gain for all 933 experiments and found that the best experiment had an expected information gain of 0.08 nats (for one participant), whereas the MS experiment had an expected information gain of only 0.03 nats; thus, the optimal experiment is expected to be 2.5 times more informative than the MS experiment.
...
\begin{figure}[t]
\centering
(a) \includegraphics[width=2.5in]{img/dist.eps} (b) \includegraphics[width=2.5in]{img/empirical.eps}
...
To validate our expected information gain calculations, we ran both the MS and optimal experiments with 40 participants.
Figure~\ref{fig:dist}b shows that, while both experiments achieve maximal actual information gain with 40 participants, the optimal experiment reaches this maximum with only 8 participants, whereas the MS experiment requires 20.
