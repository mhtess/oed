...
Though the space is considerably larger, thus hindering sequential exploration of each experiment by the scientist, it is still sufficiently small to be fully enumerated automatically in a reasonable amount of time. 
Our OED analysis revealed that the MS experiment was in the top \red{n\%} experiments in terms of their expected information gain. 
