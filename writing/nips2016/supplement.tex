...
Recall that the prototype model assumes people do not store information about all training examples but instead summary prototypes of A and B (these are computed from the training value by taking the mode).
...
\begin{lstinputlisting}[caption=Prototype model in WebPPL, upquote=true]{prototype.wppl}
